...
<%
	...
	if (!duzenle_varmi) {
		...
		String hukum = request.getParameter("hukum");
		...
		try {
			...
			int sonuc = st.executeUpdate("update admin set hukum = '"+hukum+"' where id = '"+id+"'");
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li><a href="index.jsp"><i class="fa fa-home"></i>
									Anasayfa</a></li>
							<li class="active">Hüküm Ve Koşullar</li>
						</ul>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							<header class="panel-heading">Hüküm Ve Koşullar </header>
							...
							<div class="panel-body">
								...
								<div class="form-group">
											...
											<div class="col-sm-6">
												<textarea cols="100%" rows="5" name="hukum"><% out.print(hkm); %></textarea> 
											</div>
										</div>		
