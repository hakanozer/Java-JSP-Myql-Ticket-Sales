...
<%
	...
	if (!duzenle_varmi) {
		...
		String hakkimizda = request.getParameter("hakkimizda_yazi");
		...
		try {
			...
			int sonuc = st.executeUpdate("update admin set hakkimizda = '"+hakkimizda+"' where id = '"+id+"'");
...
<%
	...
	String icerik = "";
		...
		try {
			...
			icerik = rsk.getString("hakkimizda");
			...
			<section class="wrapper">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<section class="panel">
							<header class="panel-heading">Hakkımızda </header>
							...
							<div class="panel-body">
								...
								<div class="form-group">
											...
											<div class="col-sm-6">
												<textarea cols="100%" rows="5" name="hakkimizda_yazi"><% out.print(icerik); %></textarea> 
											</div>
										</div>		
