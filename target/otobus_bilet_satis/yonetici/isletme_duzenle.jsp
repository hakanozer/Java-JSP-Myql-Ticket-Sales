...
<%
	...
	if (!duzenle_varmi) {
		...
		try {
			...
			int degistir = st
					.executeUpdate("update isletme set kullanici_adi = '"
							+ kullanici_adi
							+ "',sifresi = '"
							+ sifresi
							+ "',yetkili_adi_soyadi = '"
...
<%
	...
	if (!id_varmi) {
		...
		try{
			...
			int yaz = st.executeUpdate("INSERT INTO  proje.isletme (id ,firma_unvani , kullanici_adi ,sifresi , yetkili_adi_soyadi ,yetkili_mail ,yetkili_telefon , firma_adresi , firma_telefon , firma_fax , firma_mail , firma_web , logo , banka_bilgileri , vergi_bilgileri , durum , kayit_tarihi	)VALUES (NULL ,  '"+firma_unvani+"',  '"+kullanici_adi+"',  '"+sifresi+"',  '"+yetkili_adi_soyadi+"',  '"+yetkili_mail+"',  '"+yetkili_telefon+"',  '"+firma_adresi+"',  '"+firma_telefon+"',  '"+firma_fax+"',  '"+firma_mail+"',  '"+firma_web+"',  '"+logo+"',  '"+banka_bilgileri+"',  '"+vergi_bilgileri+"',  '"+durum+"',  now())");
			if(yaz >0){
				response.sendRedirect("isletme_kontrolu.jsp");
			}
			...
			<section class="wrapper">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<section class="panel">
							<header class="panel-heading">İşletme Düzenle </header>
							...
							<li>
								<div class="prog-row">
									<div class="user-thumb">
										<a href="#"><img src="../dosya/images/avatar1_small.jpg" alt=""></a>
									</div>
								...
								<div class="prog-row">
									<div class="user-thumb">
										<a href="#"><img src="../dosya/images/chat-avatar2.jpg" alt=""></a>
									</div>
									<div class="user-details">
										<h4>
											<a href="#">John Doe</a>
