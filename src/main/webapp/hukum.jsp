...
<head>
<title>Ottobüs Biletim - Hüküm Ve Koşullar</title>
			...
			<div id="CustomPageContent">
				<div id="CustomPageLayout">
					...
					<div id="CustomPageRightPanel">
						...
						<h1 style="font-size: 25px;padding: 19px;color: rgb(0, 114, 190);">Hüküm Ve Koşullar</h1>
								...
								<td ID="C0_Cell_1_0"><div id="ContentContainer">
										<div id="ContentText" class="CustomPageContent">
											...
											%>
												...
												<font size="2" face="Verdana"><% out.print(oku.getString("hukum"));  %></font>
											</div>
