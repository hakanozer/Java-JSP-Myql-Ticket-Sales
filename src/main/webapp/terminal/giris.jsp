...
<title>Terminal Giriş Paneli</title>
...
<body class="login-body">
	...
	<div class="container">
		...
		<form class="form-signin" action="giris_kontrol.jsp" method="post">
			<h2 class="form-signin-heading">Personel Giriş Paneli</h2>
			<div class="login-wrap">
				<div class="user-login-info">
					<input type="text" name="kullanici_adi" class="form-control"
						placeholder="Kullanıcı Adı" autofocus> <input
						type="password" name="sifre" class="form-control"
						placeholder="Şifre">
				</div>
				<label class="checkbox"> <input type="checkbox"
					name="beni_hatirla" value="beni_hatirla"> Beni Hatırla

				</label>
				<button class="btn btn-lg btn-login btn-block" type="submit">Giriş
					Yap</button>
