...
ResultSet rs;
try{
rs=st.executeQuery("select *,terminal.kayit_tarihi as a,personel.kayit_tarihi as b from terminal inner join personel where personel.id='"+session.getAttribute("personel_id")+"' and terminal.id=personel.terminal_id");
rs.next();
							...
							<div class="panel-body profile-information">
								...
								<div class="col-md-6">
									<div class="profile-desk">
										<h1><%=rs.getString("personel_adiSoyadi") %></h1>
										<span class="text-muted"><%=rs.getString("kullanici_adi") %></span><br>
										<p>
											<%=rs.getString("adresi") %><br> Telefon:<%=rs.getString("telefon") %><br>
											Email :<%=rs.getString("mail") %><br> Kayıt Tarihi:<%=rs.getString("b") %>
										</p>
								...
								<div class="col-md-6">
									<div class="profile-statistics">
										<h1><%=rs.getString("terminal_adi") %></h1>
										<!--  <span class="text-muted"><%=rs.getString("isletme_id") %></span><br>
                               -->
										<p>
											<%=rs.getString("terminal_adresi") %><br> Telefon:<%=rs.getString("terminal_telefon") %><br>
											Fax:<%=rs.getString("terminal_fax") %><br> Kayıt Tarihi:<%=rs.getString("a") %>
										</p>
									</div>
								</div>
							</div>
