...
<%
	...
	if (!sil_olay) {
		...
		int durum = st
				.executeUpdate("update yolcular set durum = 2 where id = '"
						+ id + "'");
		if (durum > 0) {
...
<body>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Yolcular</li>
						</ul>
						<!--breadcrumbs end -->

						<section class="panel">
							<header class="panel-heading">
								Yolcular <span class="tools pull-right"> <a
 ...
 %>
												...
												<td class="center hidden-phone"><a
													href="yolcular_duzenle.jsp?id=<%out.print(rs.getString("id"));%>"><button
