...
bilet_id=request.getParameter("id");
	try{
		...
		ResultSet b_rs = st.executeQuery("select y.adi, y.soyadi,b.yolcu_tcno, s.kalkis, s.varis, s.tarih, s.saat, b.koltuk_no, b.ucret from biletler as b inner join seferler as s inner join yolcular as y where s.id=b.sefer_id and y.yolcu_tc=b.yolcu_tcno and b.id='"+request.getParameter("id")+"'");
		b_rs.next();
	 ...
	 int biletdurum=st.executeUpdate("update biletler set durum='0' where id='"+bilet_id+"'");
	 if(biletdurum>0){
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Rezerve Bilet Kullanım Ekranı</li>
						</ul>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							...
							<div class="panel-body">
								<form class="form-horizontal bucket-form"
									...
									<div class="form-group">
										<label class=" col-sm-3 control-label">Saat</label>
										<div class="col-lg-6">
											<p class="form-control-static">
												<% out.print(saat); %>
											</p>
									...
									<div class="form-group">
										<label class=" col-sm-3 control-label">Koltuk No</label>
										<div class="col-lg-6">
											<p class="form-control-static">
												<% out.print(koltukno); %>
											</p>
