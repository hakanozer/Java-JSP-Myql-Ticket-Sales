...
<body>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li class="active">İletişim Kontrolü</li>
						</ul>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							<header class="panel-heading">
								İletişim <span class="tools pull-right"> <a
									href="iletisim_duzenle.jsp?isletme_id=<%out.print(session.getAttribute("yonetici_id"));%>"><button
											type="button" class="btn btn-danger"
											style="margin-top: -7px;">İletişim Bilgilerini
											Düzenle</button></a>
								...
								<div class="position-left">
									...
									<form class="form-horizontal bucket-form" action=""
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<label class="col-sm-2 control-label" for="adres"> <%
 ...
 %>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<label class="col-sm-2 control-label" for="telefon">
													<%
 ...
 %>
		...
		<section class="panel">
			<header class="panel-heading">
				İletişim <span class="tools pull-right"> <a
					href="iletisim_duzenle.jsp?isletme_id=<%out.print(session.getAttribute("yonetici_id"));%>"><button
							type="button" class="btn btn-danger" style="margin-top: -7px;">İletişim
				...
				<div class="position-left">
					...
					<form class="form-horizontal bucket-form" action="" method="post">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="adres">Adres:</label>
							<div class="col-sm-6">
								<label class="col-sm-2 control-label" for="adres"></label>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="telefon">Telefon:</label>
							<div class="col-sm-6">
								<label class="col-sm-2 control-label" for="telefon"></label>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="mail">Mail
								Adresi:</label>
							<div class="col-sm-6">
								<label class="col-sm-2 control-label" for="mail"></label>
							</div>
						</div>
