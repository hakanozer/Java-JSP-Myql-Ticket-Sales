	...
	<section id="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Duyurular Kontrolü</li>
						</ul>
						<!--breadcrumbs end -->
						<%
							ResultSet r = st
						...
						<section class="panel">
							<header class="panel-heading">
								Duyurular <span class="tools pull-right"> <a
									href="duyurular_duzenle.jsp?isletme_id=<%out.print(session.getAttribute("yonetici_id"));%>"><button
											type="button" class="btn btn-danger"
											style="margin-top: -7px;">Duyurular Bilgilerini
											Düzenle</button></a>
								...
								<div class="position-left">
									...
									<form class="form-horizontal bucket-form" action=""
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<label class="col-sm-2 control-label" for="duyurular">
													<%
														out.print(rs.getString("duyurular"));
													%>
												</label>
											</div>
										</div>
		...
		<section class="panel">
			<header class="panel-heading">
				Duyurular <span class="tools pull-right"> <a
					href="duyurular_duzenle.jsp?isletme_id=<%out.print(session.getAttribute("yonetici_id"));%>"><button
							type="button" class="btn btn-danger" style="margin-top: -7px;">Duyurular
				...
				<div class="position-left">
					...
					<form class="form-horizontal bucket-form" action="" method="post">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="duyurular">Duyurular:</label>
							<div class="col-sm-6">
								<label class="col-sm-10 control-label" for="duyurular"></label>
							</div>
						</div>
