...
<%
	...
	if (!sil_olay) {
		...
		int durum = st
				.executeUpdate("update isletme set durum = 0 where id = '"
						+ id + "'");
		if (durum > 0) {
...
<!--dynamic table-->
<link  href="../dosya/js/advanced-datatable/css/demo_page.css" rel="stylesheet" />
<link  href="../dosya/js/advanced-datatable/css/demo_table.css" rel="stylesheet" />
...
<body>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li class="active">İşletme Arşivi</li>
								...
								<div class="adv-table">
									<table class="display table table-bordered table-striped"
										...
										<tbody>
											...
											<%
												ResultSet rs = st
														.executeQuery("select *from isletme where durum =2 order by id desc");
												while (rs.next()) {
											%>
 ...
 %>
	...
	<script type="text/javascript" src="../dosya/js/data-tables/DT_bootstrap.js"></script>
