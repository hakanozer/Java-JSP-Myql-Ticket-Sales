...
<%
	...
	if (!duzenle_varmi) {
		...
		String uyelik = request.getParameter("uyelik");
		...
		try {
			...
			int sonuc = st.executeUpdate("update admin set uyelik = '"+uyelik+"' where id = '"+id+"'");
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li><a href="index.jsp"><i class="fa fa-home"></i>
									Anasayfa</a></li>
							<li class="active">Uyelik Anlaşması</li>
						</ul>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							<header class="panel-heading">Uyelik Anlaşması </header>
							...
							<div class="panel-body">
								...
								<div class="form-group">
											...
											<div class="col-sm-6">
												<textarea cols="100%" rows="5" name="uyelik"><% out.print(uyel); %></textarea> 
											</div>
										</div>		
