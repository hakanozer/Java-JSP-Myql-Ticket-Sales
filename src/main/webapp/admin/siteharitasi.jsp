...
<%
	...
	if (!duzenle_varmi) {
		...
		String siteharitasi = request.getParameter("siteharitasi");
		String id = request.getParameter("id");

		try {

			int sonuc = st.executeUpdate("update admin set siteharitasi = '"
							+ siteharitasi + "' where id = '" + id
							+ "'");
...
<%
	...
	try {
		...
		ResultSet rsk = st1.executeQuery("select *from admin where id = '1'");
		rsk.next();
		kullanici_adi = rsk.getString("kullanici_adi");
		sifre = rsk.getString("sifre");
		sharitasi = rsk.getString("siteharitasi");
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li><a href="index.jsp"><i class="fa fa-home"></i>
									Anasayfa</a></li>
							<li class="active">Site Haritası</li>
						</ul>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							<header class="panel-heading">Site Haritası </header>

							<div class="panel-body">
								<div class="position-left">

									<form class="form-horizontal bucket-form"
										action="?duzenle=duzenle&id=1" method="post">


										<div class="form-group">
											<label class="col-sm-2 control-label"></label>
											<div class="col-sm-6">
												<textarea cols="100%" rows="5" name="siteharitasi">
													<%
														out.print(sharitasi);
													%>
												</textarea>
