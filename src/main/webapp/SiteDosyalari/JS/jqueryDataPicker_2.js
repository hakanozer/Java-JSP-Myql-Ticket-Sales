		...
		if (showOn == 'button' || showOn == 'both') { // pop-up date picker when button clicked
			...
			inst.trigger = $(this._get(inst, 'buttonImageOnly') ?
				$('<img/>').addClass(this._triggerClass).
					attr({ id: 'calenderButton', src: buttonImage, alt: buttonText, title: buttonText }) :
				$('<button type="button"></button>').addClass(this._triggerClass).
					html(buttonImage == '' ? buttonText : $('<img/>').attr(
					{ id: 'calenderButton', src: buttonImage, alt: buttonText, title: buttonText })));
...
$('.datetimepicker').datepicker({ showOn: 'button', buttonImage: '/accris/?DisplayImage=ResourceName,,Calendar.gif$$$Namespace,,Ardita', buttonImageOnly: true }); 
