<%@include file="yonetici/kontrol.jsp"%>
<%@ page contentType="text/html; charset=UTF-8" language="java"
	import="java.sql.*" import="java.*" errorPage=""%>
<%@ include file="yonetici/ayar.jsp"%>
...
<%
	...
	if (!sil_olay) {
		...
		int durum = st
				.executeUpdate("delete from terminal where id = '" + id
						+ "'");
		if (durum > 0) {
...
<body>
	<section id="container">
		...
		<%@include file="yonetici/sol_menu.jsp"%>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Terminal Kontrolü</li>
						</ul>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							<header class="panel-heading">
								Terminaller <span class="tools pull-right"> <a
									href="yeni_terminal.jsp"><button type="button"
											class="btn btn-danger" style="margin-top: -7px;">Yeni
											Terminal Ekle</button></a>
								</span>
								...
								<div class="adv-table">
									<table class="display table table-bordered table-striped"
										...
										<tbody>
											...
											<%
												ResultSet rs = st
														.executeQuery("select *from terminal where isletme_id = '"
											...
											<tr class="gradeX">
												...
												<td>
													<%
														out.print(rs.getString("terminal_adi"));
													%>
												</td>
												<td>
													<%
														out.print(rs.getString("terminal_adresi"));
													%>
												</td>
												<td class="center hidden-phone">
													<%
														out.print(rs.getString("terminal_telefon"));
													%>
												</td>
												<td class="center hidden-phone">
													<%
 ...
 %>
												...
												<td class="center hidden-phone"><a
													href="terminal_duzenle.jsp?id=<%out.print(rs.getString("id"));%>"><button
